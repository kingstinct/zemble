...
const ArraySubFieldName = ({ entityName, arrayFieldName, subFieldName }: ArraySubFieldNameProps) => `${capitalize(entityName)}${capitalize(arrayFieldName)}${capitalize(subFieldName)}`
