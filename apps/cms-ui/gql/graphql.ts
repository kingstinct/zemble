...
export type LoginConfirmMutation = { __typename?: 'Mutation', loginConfirm: { __typename: 'CodeNotValidError', message: string } | { __typename: 'EmailNotValidError', message: string } | { __typename: 'LoginConfirmSuccessfulResponse', bearerToken: string } | { __typename: 'LoginFailedError', message: string } };
