...
function SelectEntityRelation<T extends FieldValues>({ control, fieldName, entityNamePlural, label = fieldName, onChange: onChangeFromProps, onClose }: SelectEntityRelationProps<T>) {
    ...
    <Controller
      ...
      render={({ field: { onChange, value } }) => (
        ...
        >
          ...
          <Searchbar style={{ margin: 8 }} value={query} onChangeText={setQuery} placeholder='Search for entity..' />
          <ScrollView>
            {entity ? (
              <SearchEntries
                entity={entity}
