...
export const SharedPortalAreaProvider: React.FC<
  PropsWithChildren<SharedPortalAreaProviderProps>
> = ({ children, insets }) => {
  const setDefaultInsets = useSharedPortalAreaStore(
    (state) => state.setDefaultInsets,
  )
