...
export const SharedPortalPresentationArea: React.FC<SharedPortalPresentationAreaProps> = ({ children, style, colorize }) => {
  ...
  return (
    <NativePortal insets={insets} colorize={colorize}>
      <Animated.View layout={CurvedTransition.duration(500)} onLayout={onLayout} style={style} pointerEvents='box-none'>
        {children}
      </Animated.View>
    </NativePortal>
  )
