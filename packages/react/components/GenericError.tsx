...
export const GenericError: React.FC<GenericErrorProps> = ({ onTryAgain, onTryAgainWithNetworkStatus, customMessage, error }) => {
  ...
  return (
    <View style={styles.container}>
      <MaterialCommunityIcons name={!hasBeenOffline ? 'alert' : 'lightning-bolt-circle'} style={styles.icon} />
      <Text style={styles.text}>{message}</Text>
      {onTryAgain ? <Button onPress={doTryAgain} title={strings['Try again']} /> : null}
