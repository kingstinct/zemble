...
import type { DimensionValue, TextProps as NativeTextProps, StyleProp, TextStyle, ViewProps, ViewStyle } from 'react-native'
...
export type PrimitiveViewProps = Omit<ViewProps, 'style'> &
  SharedProps & {
