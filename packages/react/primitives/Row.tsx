...
export const Row = createThemedView(
  ({ center, spaceBetween, spaceAround, spaceEvenly, centerY, centerX, fill, colorize, marginX, marginY, backgroundColor, paddingY, colorizeBorder, paddingX, wrap, style, ...props }: RowProps) => [
    {
