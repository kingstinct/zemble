...
export type BookContributorsInput =
  { readonly author: Scalars['ID']['input']; readonly editor?: never; }
  |  { readonly author?: never; readonly editor: Scalars['ID']['input']; };
...
export type BookContributorsAuthorResolvers<ContextType = Zemble.GraphQLContext, ParentType extends ResolversParentTypes['BookContributorsAuthor'] = ResolversParentTypes['BookContributorsAuthor']> = ResolversObject<{
  author?: Resolver<Maybe<ResolversTypes['AuthorsRelation']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
}>;

export type BookContributorsEditorResolvers<ContextType = Zemble.GraphQLContext, ParentType extends ResolversParentTypes['BookContributorsEditor'] = ResolversParentTypes['BookContributorsEditor']> = ResolversObject<{
  editor?: Resolver<Maybe<ResolversTypes['AuthorsRelation']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
}>;

export type BookContributorsUnionResolvers<ContextType = Zemble.GraphQLContext, ParentType extends ResolversParentTypes['BookContributorsUnion'] = ResolversParentTypes['BookContributorsUnion']> = ResolversObject<{
