...
test('should create a book with authors', async () => {
  ...
  const { data: christopher } = await app.gqlRequestUntyped<CreateAuthorMutationType>(
  ...
  const createBookReq = await app.gqlRequestUntyped<{ readonly createBook: unknown }, unknown>(
    `mutation { 
...
test('should filter on title field', async () => {
  ...
  const results = await app.gqlRequestUntyped<
    ...
    unknown
  >('query { filterBooks(title: { eq: "Lord of the rings" }) { title } }', {}, opts)
...
test('should get default hasKindleVersion', async () => {
  ...
  const results = await app.gqlRequestUntyped<
    ...
    unknown
  >('query { searchBooks(query: "Lord of") { title hasKindleVersion } }', {}, opts)
