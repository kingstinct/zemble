...
export interface ApplePushOptions extends Zemble.GlobalConfig {
  ...
  readonly persistPushToken: (decodedToken: TokenContents, pushTokenWithMetadata: AnyPushTokenWithMetadata) => Promise<void>
  readonly handleExpiredPushTokens: (pushTokenWithMetadata: readonly AnyPushTokenWithMetadata[]) => Promise<void>
  readonly handlePushTokenErrors?: (pushTokenWithMetadata: readonly PushTokenWithContentsAndFailedReason<AnyPushTokenWithMetadata>[]) => Promise<void>
  readonly handleLiveActivityStateChange?: (args: MutationAppleLiveActivityStateUpdatedArgs, context: Zemble.GraphQLContext) => Promise<void>
}
