...
export type MutationResolvers<ContextType = Zemble.GraphQLContext, ParentType extends ResolversParentTypes['Mutation'] = ResolversParentTypes['Mutation']> = ResolversObject<{
  ...
  registerAppleUpdateLiveActivityPushToken?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<MutationRegisterAppleUpdateLiveActivityPushTokenArgs, 'activityId' | 'appBundleId' | 'liveActivityType' | 'token'>
  >
...
export type StartLiveActivityResponseResolvers<
  ContextType = Zemble.GraphQLContext,
  ParentType extends ResolversParentTypes['StartLiveActivityResponse'] = ResolversParentTypes['StartLiveActivityResponse'],
> = ResolversObject<{
