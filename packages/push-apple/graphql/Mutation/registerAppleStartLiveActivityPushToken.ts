...
const registerAppleStartLiveActivityPushToken: MutationResolvers['registerAppleStartLiveActivityPushToken'] =
  async (_, { token, appBundleId, isSandbox }, { decodedToken }) => {
