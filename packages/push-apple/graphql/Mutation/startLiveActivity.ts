...
const startLiveActivityResolver: MutationResolvers['startLiveActivity'] = async (_, { data, liveActivityType, pushToken }) => {
  ...
  ], { contentState: data, attributesType: liveActivityType, body: 'Starting live activity' })
