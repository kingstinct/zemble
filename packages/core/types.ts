...
export type SendPushProvider = (pushTokens: readonly PushTokenWithMetadata[], message: PushMessage) => PromiseOrValue<SendPushResponse<PushTokenWithMetadata>>
export type SendSilentPushProvider = (pushTokens: readonly PushTokenWithMetadata[], data: Record<string, JSON>) => PromiseOrValue<SendPushResponse<PushTokenWithMetadata>>
...
export type Middleware<TMiddlewareConfig extends Zemble.GlobalConfig, PluginType extends Plugin = Plugin> = (opts: {
