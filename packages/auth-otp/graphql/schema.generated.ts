...
export type CodeNotValidErrorResolvers<
  ContextType = Zemble.GraphQLContext,
  ParentType extends ResolversParentTypes['CodeNotValidError'] = ResolversParentTypes['CodeNotValidError'],
> = ResolversObject<{
  message?: Resolver<ResolversTypes['String'], ParentType, Zemble.AuthContextWithToken<ContextType>>
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>
}>

export type EmailNotValidErrorResolvers<
  ContextType = Zemble.GraphQLContext,
  ParentType extends ResolversParentTypes['EmailNotValidError'] = ResolversParentTypes['EmailNotValidError'],
> = ResolversObject<{
  message?: Resolver<ResolversTypes['String'], ParentType, Zemble.AuthContextWithToken<ContextType>>
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>
}>
...
export type LoginConfirmSuccessfulResponseResolvers<
  ContextType = Zemble.GraphQLContext,
  ParentType extends ResolversParentTypes['LoginConfirmSuccessfulResponse'] = ResolversParentTypes['LoginConfirmSuccessfulResponse'],
> = ResolversObject<{
...
export type LoginConfirmWithEmailResponseResolvers<
  ContextType = Zemble.GraphQLContext,
  ParentType extends ResolversParentTypes['LoginConfirmWithEmailResponse'] = ResolversParentTypes['LoginConfirmWithEmailResponse'],
> = ResolversObject<{
...
export type LoginConfirmWithSmsResponseResolvers<
  ContextType = Zemble.GraphQLContext,
  ParentType extends ResolversParentTypes['LoginConfirmWithSmsResponse'] = ResolversParentTypes['LoginConfirmWithSmsResponse'],
> = ResolversObject<{
...
export type LoginRequestSuccessResponseResolvers<
  ContextType = Zemble.GraphQLContext,
  ParentType extends ResolversParentTypes['LoginRequestSuccessResponse'] = ResolversParentTypes['LoginRequestSuccessResponse'],
> = ResolversObject<{
  success?: Resolver<ResolversTypes['Boolean'], ParentType, Zemble.AuthContextWithToken<ContextType>>
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>
}>

export type LoginRequestWithEmailResponseResolvers<
  ContextType = Zemble.GraphQLContext,
  ParentType extends ResolversParentTypes['LoginRequestWithEmailResponse'] = ResolversParentTypes['LoginRequestWithEmailResponse'],
> = ResolversObject<{
  __resolveType: TypeResolveFn<'EmailNotValidError' | 'LoginRequestSuccessResponse', ParentType, ContextType>
}>

export type LoginRequestWithSmsResponseResolvers<
  ContextType = Zemble.GraphQLContext,
  ParentType extends ResolversParentTypes['LoginRequestWithSmsResponse'] = ResolversParentTypes['LoginRequestWithSmsResponse'],
> = ResolversObject<{
...
export type MutationResolvers<ContextType = Zemble.GraphQLContext, ParentType extends ResolversParentTypes['Mutation'] = ResolversParentTypes['Mutation']> = ResolversObject<{
  loginConfirmWithEmail?: Resolver<
    ResolversTypes['LoginConfirmWithEmailResponse'],
    ParentType,
    Zemble.AuthContextWithToken<ContextType>,
    RequireFields<MutationLoginConfirmWithEmailArgs, 'code' | 'email'>
  >
  loginConfirmWithSms?: Resolver<
    ResolversTypes['LoginConfirmWithSmsResponse'],
    ParentType,
    Zemble.AuthContextWithToken<ContextType>,
    RequireFields<MutationLoginConfirmWithSmsArgs, 'code' | 'phoneNumberWithCountryCode'>
  >
  ...
  loginRequestWithSms?: Resolver<
    ResolversTypes['LoginRequestWithSmsResponse'],
    ParentType,
    Zemble.AuthContextWithToken<ContextType>,
    RequireFields<MutationLoginRequestWithSmsArgs, 'phoneNumberWithCountryCode'>
  >
}>

export type PhoneNumNotValidErrorResolvers<
  ContextType = Zemble.GraphQLContext,
  ParentType extends ResolversParentTypes['PhoneNumNotValidError'] = ResolversParentTypes['PhoneNumNotValidError'],
> = ResolversObject<{
  message?: Resolver<ResolversTypes['String'], ParentType, Zemble.AuthContextWithToken<ContextType>>
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>
}>
