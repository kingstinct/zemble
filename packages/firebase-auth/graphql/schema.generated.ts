...
export type MutationResolvers<ContextType = Zemble.GraphQLContext, ParentType extends ResolversParentTypes['Mutation'] = ResolversParentTypes['Mutation']> = ResolversObject<{
  createUserWithEmailAndPassword?: Resolver<
    ResolversTypes['AuthResponse'],
    ParentType,
    Zemble.AuthContextWithToken<ContextType>,
    RequireFields<MutationCreateUserWithEmailAndPasswordArgs, 'email' | 'password'>
  >
  signInWithEmailAndPassword?: Resolver<
    ResolversTypes['AuthResponse'],
    ParentType,
    Zemble.AuthContextWithToken<ContextType>,
    RequireFields<MutationSignInWithEmailAndPasswordArgs, 'email' | 'password'>
  >
}>
