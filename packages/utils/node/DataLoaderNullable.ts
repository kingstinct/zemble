...
export class DataLoaderNullable<
  V extends { readonly _id: ObjectId },
  K extends Key<V>,
  C extends string,
> extends DataLoader<K, PartialWithId<V>, C> {
  ...
  async loadNullable<K2 extends K>(
    key: K2,
  ): Promise<K2 extends IdWithoutProjection ? Required<V> | null : V | null> {
    try {
  ...
  async loadManyNullable<K2 extends K>(
    keys: ArrayLike<K2>,
  ): Promise<ReadonlyArray<(K2 extends IdWithoutProjection ? V : V) | null>> {
...
export default DataLoaderNullable
