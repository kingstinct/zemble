...
>(
  ...
  type Acc = {
    readonly stages: readonly TPipelineStage[]
    readonly result: readonly TRetVal[]
  }
...
----------------------------------------`)
    ...
    Promise.resolve({
      stages: [] as readonly TPipelineStage[],
      result: {} as readonly TRetVal[],
    }),
  )
